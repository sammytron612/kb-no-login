                ...
                <div class="flex-1">
                    ...
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-yellow-800 dark:text-yellow-200 flex-1">
                                <strong>Enabled:</strong> Advanced search with better relevance and slower seek times (full article is searched)<br>
                                <strong>Disabled:</strong> Basic search functionality only (only title and tags are searched)
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="p-4 md:p-6">
            <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6">
                <div class="flex-1">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm mb-4">
                        Allow users with the editor role to delete their own articles without admin approval.
                    </p>

                    <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-4">
                        <div class="flex items-start">
                            <flux:icon.trash class="w-5 h-5 text-red-600 dark:text-red-400 mt-0.5 mr-3 flex-shrink-0" />
                            <div class="text-sm text-red-800 dark:text-red-200 flex-1">
