        ...
        <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
                ...
                <a href="{{ route('admin.invites') }}" class="group block" wire:navigate>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-medium text-gray-900 dark:text-white text-sm">Invites</div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Manage users</div>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.users') }}" class="group block" wire:navigate>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md hover:border-green-300 dark:hover:border-green-600 transition-all duration-200">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-green-50 dark:bg-green-900/30 rounded-lg flex items-center justify-center group-hover:bg-green-100 dark:group-hover:bg-green-900/50 transition-colors duration-200">
                                <svg class="w-5 h-5 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
                                </svg>
                            </div>
                            <div>
                                <div class="font-medium text-gray-900 dark:text-white text-sm">Users</div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">User accounts</div>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.approvals') }}" class="group block" wire:navigate>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md hover:border-orange-300 dark:hover:border-orange-600 transition-all duration-200">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-orange-50 dark:bg-orange-900/30 rounded-lg flex items-center justify-center group-hover:bg-orange-100 dark:group-hover:bg-orange-900/50 transition-colors duration-200 relative">
                            ...
                            <div>
                                <div class="font-medium text-gray-900 dark:text-white text-sm">Approvals</div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Review content</div>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md hover:border-purple-300 dark:hover:border-purple-600 transition-all duration-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600 dark:text-gray-400">System config</div>
                            </div>
                        </div>
                    </div>
                </a>
